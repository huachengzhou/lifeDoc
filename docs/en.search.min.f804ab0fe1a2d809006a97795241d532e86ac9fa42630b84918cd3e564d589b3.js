...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/life/flexsearch.min.js');loadScript('/life/en.search-data.min.2129a825337794618785dcf6745caf49d61292bab4e42e65a34516276fee6a3d.js',function(){input.required=false;search();});}
