...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/life/flexsearch.min.js');loadScript('/life/en.search-data.min.66988af165aad8475bda176bde93751bdb269be5e550242935737ad43eacde49.js',function(){input.required=false;search();});}
