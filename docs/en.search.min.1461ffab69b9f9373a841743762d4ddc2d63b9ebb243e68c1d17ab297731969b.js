...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/life/flexsearch.min.js');loadScript('/life/en.search-data.min.3a600339a740f95eac9dd6b993229e2cd3f3aba07a84faf536673aebab398ccd.js',function(){input.required=false;search();});}
