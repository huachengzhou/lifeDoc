...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/life/flexsearch.min.js');loadScript('/life/en.search-data.min.5bb569437df17af26e10e3e4a8a5a47f7bdda999680752a6da7a2b4443a0eaa4.js',function(){input.required=false;search();});}
