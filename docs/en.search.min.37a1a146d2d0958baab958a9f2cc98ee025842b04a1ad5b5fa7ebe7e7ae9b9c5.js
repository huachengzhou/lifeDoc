...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/life/flexsearch.min.js');loadScript('/life/en.search-data.min.7e6720e4ec125255a668427b279100075d2687060edbc4bfbd0fde99cd95bb71.js',function(){input.required=false;search();});}
