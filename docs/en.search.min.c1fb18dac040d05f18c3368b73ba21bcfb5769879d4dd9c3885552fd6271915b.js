...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/life/flexsearch.min.js');loadScript('/life/en.search-data.min.2123ec2ac0a7adf893bb9f88cbbdb474414765c1e1a50a2db7c092d573667067.js',function(){input.required=false;search();});}
