...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/life/flexsearch.min.js');loadScript('/life/en.search-data.min.2b75d5d33b08a245fffbea7b96405865bea12b38d3118451ff241e7a40278265.js',function(){input.required=false;search();});}
