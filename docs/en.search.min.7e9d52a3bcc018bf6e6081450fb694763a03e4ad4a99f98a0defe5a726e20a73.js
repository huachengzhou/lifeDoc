...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/life/flexsearch.min.js');loadScript('/life/en.search-data.min.15b6ff2a0c4fdbff046780b3db39f6fe57f69aff2639b80aaa99205093c2bf2f.js',function(){input.required=false;search();});}
