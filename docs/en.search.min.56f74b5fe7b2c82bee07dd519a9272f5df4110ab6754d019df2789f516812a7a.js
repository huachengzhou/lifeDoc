...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/life/flexsearch.min.js');loadScript('/life/en.search-data.min.25a3463a4cecd273203e145d78887379f757427ae73968d468cd3f878a8f71c2.js',function(){input.required=false;search();});}
