...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/life/flexsearch.min.js');loadScript('/life/en.search-data.min.be49235eefd5cfdbeada80dfdf045571edfdf0084ebe8c3ba6e73a34a3e2d80c.js',function(){input.required=false;search();});}
